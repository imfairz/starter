...
sudo pacman -S base-devel git curl bat vlc{,-plugins-all} tree tmux alacritty btop neovim fzf go lazygit zsh zed zoxide nvm pnpm php ttf-jetbrains-mono{,-nerd} docker docker-compose okular gwenview
